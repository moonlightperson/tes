	...
	window.onload = function () {
		...
		const sections = [
			...
			{section: "Informatiomn", renderSection: _ => [
				createElement(`<div class="welcome-message">Welcome to my Repository site</div>`),
				createElement(`<div class="divider"></div>`),
				createElement(`<div class="welcome-details">Here you can find the best plugins and themes in the whole BetterDiscord</div>`),
				createElement(`<div class="welcome-details">If you have any problems, do not hesitate and come to our discord.</div>`),
				createElement(`<div class="divider"></div>`),
				createElement(`<div class="welcome-details">I wish you a good time with a beautiful and multifunctional discord.</div>`),
