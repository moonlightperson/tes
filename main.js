(_ => {
	...
	window.onload = function () {
		...
		const sections = [
			...
			{section: "Informatiomn", renderSection: _ => [
			...
			{section: "Separator"},
			{section: "Servers", renderSection: _ => [
